...
function BandageIllustration(props: Props) {
	return (
		<svg
			...
			height="1em"
			viewBox="0 0 60 60"
			className="heroicon-repair heroicon heroicon-sm text-pink-500"
		>
			<path
				className="heroicon-repair-bottom heroicon-component-accent heroicon-component-fill"
				fill="currentColor"
				d="M20.49 3.51A12 12 0 0 0 3.5 20.5l36 36A12 12 0 0 0 56.5 39.5l-36-36z"
			/>
			<path
				className="heroicon-repair-top heroicon-component-fill"
				fill="#FFFFFF"
				d="M3.51 39.51A12 12 0 0 0 20.5 56.5l36-36A12 12 0 1 0 39.5 3.5l-36 36z"
			/>
			<polygon
				className="heroicon-shadows"
				fill="#000000"
				points="45 30 48 33 33 48 30 45"
				opacity=".2"
			/>
			<path
